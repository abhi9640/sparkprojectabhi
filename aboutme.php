...
#main2{
	width:120px;
	height: 140px;
	background: url(img/abhilash1.jpg);
	border-radius: 50%;
	float:left;
...
<body>
	...
	<ul >
			...
			<div id="main">
				<div id="main2"></div>
				<h2> Rayala Abhilash</h2>
				    <!--img id="image2" src="C:\xampp\htdocs\project\img" align="left"-->
...
<div class="social-menu">
  <ul>
    <li><a href=""><i class="fa fa-facebook"><img src="img/fb.jpeg"></i></a></li>
    <li><a href=""><i class="fa fa-linkedin"><img src="img/linkedin.jpeg"></i></a></li>
    <li><a href=""><i class="fa fa-twitter"><img src="img/twitter.jpeg"></i></a></li>
